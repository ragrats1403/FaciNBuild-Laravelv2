                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 " style="background-color: #fff4c4; padding-left:50px; padding-top:50px; padding-right:50px;">
                            ...
                            <div class="row justify-content-center" style="padding-bottom:10px;">
                                <h1 class="text-center text-uppercase" style="padding-bottom:10px;">Minor Job Request form</h1>
                                <div class="col-md-6 ">
                            ...
                            <div class="justify-content-center" style="padding-bottom:10px;">
                                <h5 class="text-uppercase" style="padding-bottom:10px;" >A. Requisition(To be filled up by the requesting party)</h5>
                                <div class="col-md-2 ">
                                    <input type="name" class="form-control input-sm col-xs-1" id="departmentmajorjr" placeholder="Quantity">
                                </div>
                            </div>
                            <div class="justify-content-center" style="padding-bottom:10px;">
                                <h5 class="text-uppercase" style="padding-bottom:10px;" >ITEM WITH COMPLETE DESCRIPTION</h5>
                                <div class="col-md-12" >
                            ...
                            <div class="row justify-content-center" style="padding-bottom:10px;">
                                <div class="col-md-6" >
                                    <label for="renderedby">Rendered by:</label>
                            ...
                            <div class="row justify-content-center" style="padding-bottom:10px;">
                                <div class="col-md-6" >
                                    <label for="renderedby">Confirmed by:</label>
                                    <input type="name" class="form-control input-sm col-xs-1" id="departmentmajorjr">
                                </div>
                                <div class="col-md-6" >
                                    <label for="date">Date:</label>
